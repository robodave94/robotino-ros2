...
{
	encoder_pub_ = parent_node->create_publisher<rto4_msgs::msg::EncoderReadings>("encoder_readings", 10);
	encoder_position_server_ = parent_node->create_service<rto4_msgs::srv::SetEncoderPosition>("set_encoder_position", std::bind(&EncoderInputROS::setEncoderPositionCallback, this, _1, _2));
}
