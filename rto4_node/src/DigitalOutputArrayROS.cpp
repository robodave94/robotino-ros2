...
{
	digital_sub_ = parent_node->create_subscription<rto4_msgs::msg::DigitalReadings>("set_digital_values", 10, std::bind(&DigitalOutputArrayROS::setDigitalValuesCallback, this, _1));
}
...
void DigitalOutputArrayROS::setDigitalValuesCallback( const rto4_msgs::msg::DigitalReadings::SharedPtr msg)
{
