...
#include "rto4_msgs/msg/digital_readings.hpp"
...
private:
	...
	rclcpp::Subscription<rto4_msgs::msg::DigitalReadings>::SharedPtr digital_sub_;

	void setDigitalValuesCallback( const rto4_msgs::msg::DigitalReadings::SharedPtr msg);
